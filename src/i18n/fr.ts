const fr: Record<string, string> = {
  land_headline: 'L\'analyse de performance en course, simplifiée.',
  land_subheadline: 'Importez vos données de session, découvrez des insights et progressez tour après tour.',
  land_cta_signup: 'Créer un compte',
  ...
  land_step_improve_desc: 'Suivez votre progression entre les sessions et corrélez les changements de réglages avec les résultats en piste.',
  land_features_title: 'Fonctionnalités principales',
  land_feat_benchmark: 'Benchmark Circuit',
  land_feat_benchmark_desc: 'Comparez votre rythme au meilleur de la session et à un tour théorique optimal.',
  land_feat_compare: 'Comparaison de Sessions',
  land_feat_compare_desc: 'Superposez plusieurs sessions pour identifier les tendances et mesurer la progression.',
  land_feat_setup: 'Corrélation Setup',
  land_feat_setup_desc: 'Associez des configurations d\'équipement aux sessions et mesurez leur impact sur la performance.',
  land_feat_insights: 'Insights Guidés',
  land_feat_insights_desc: 'Des interprétations contextuelles mettent en avant l\'essentiel — sans diplôme en data science.',
  land_workspace_note: 'StintLab est un espace de travail privé. Vos données sont stockées en sécurité dans votre compte personnel et ne sont jamais partagées sans votre consentement.',
