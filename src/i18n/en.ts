const en: Record<string, string> = {
  // Landing
  land_headline: 'Race performance analysis, made simple.',
  land_subheadline: 'Import your session data, uncover insights, and improve lap after lap.',
  land_cta_signup: 'Create Account',
  land_cta_signin: 'Sign In',
  land_how_title: 'How it works',
  land_step_import: 'Import',
  land_step_import_desc: 'Upload your timing CSV — sessions are parsed and organized automatically.',
  land_step_analyze: 'Analyze',
  land_step_analyze_desc: 'Explore lap times, sectors, stints, and driver performance with interactive charts.',
  land_step_improve: 'Improve',
  land_step_improve_desc: 'Track progress across sessions and correlate setup changes with on-track results.',
  land_features_title: 'Core capabilities',
  land_feat_benchmark: 'Track Benchmark',
  land_feat_benchmark_desc: 'Compare your pace against the session best and a theoretical optimal lap.',
  land_feat_compare: 'Session Comparison',
  land_feat_compare_desc: 'Overlay multiple sessions to identify trends and measure improvement.',
  land_feat_setup: 'Setup Correlation',
  land_feat_setup_desc: 'Link equipment configurations to sessions and measure their impact on performance.',
  land_feat_insights: 'Guided Insights',
  land_feat_insights_desc: 'Contextual interpretations highlight what matters — no data science degree required.',
